...
export function isTranslation(translation: Translations[string]): translation is PluralisedTranslation {
    return typeof translation === "object" && "one" in translation && "other" in translation;
}
